...
const apps: AppManifest[] = [
  ...
  { id: "lora-studio", name: "LoRA Studio", icon: "layers", category: "studio", component: () => import("@/apps/LoRAStudioApp").then((m) => ({ default: m.LoRAStudioApp })), defaultSize: { w: 1080, h: 720 }, minSize: { w: 680, h: 480 }, singleton: true, pinned: false, launchpadOrder: 13.33, optional: true },
